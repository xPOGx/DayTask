...
import com.example.daytask.util.Constants.tenMinutesInMillis
...
class NewTaskViewModel : ViewModel() {
    ...
    private val ref = database.child("users/$userId/tasks").push()
...
data class NewTaskUiState(
    val title: String = "",
    val details: String = "",
    val date: Long = Calendar.getInstance().timeInMillis + tenMinutesInMillis,
